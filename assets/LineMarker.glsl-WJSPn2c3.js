import{vD as K,FI as X,FJ as ee,El as te,Ej as ie,FK as re,FL as ae,Eq as o,FB as se,EZ as oe,FA as ne,Ep as w,FM as ce,FN as le,Em as pe,Eo as de,Er as he,Fk as ve,Et as ue,FO as A,FP as N,FQ as me,FR as fe,F1 as ge,g0 as Se,Eu as Pe,Ev as ye,_ as _e,Ew as W,Ey as R,Ez as we,EA as U,EB as C,F2 as ze,ED as xe,EE as $e,EG as Te,EC as be,EH as V,FS as Ve,FT as I,FU as B,FV as ke,FW as Oe,FX as Fe,EI as De,n as p,EJ as d,fZ as Ee,F4 as We,FY as q,qs as Ce,Fs as Me,kF as Le,EO as je,cb as H,cc as Y,xj as Ae,gy as J,FZ as Ne}from"./index-zfTcqrFg.js";function Z(r){const e=new K,{space:i,anchor:t,hasTip:P,hasScreenSizePerspective:z}=r,u=i===2,g=i===1;e.include(X,r),e.include(ee,r),e.include(te,r);const{vertex:a,fragment:S,varyings:y}=e;ie(a,r),e.attributes.add("position","vec3"),e.attributes.add("previousDelta","vec4"),e.attributes.add("uv0","vec2"),y.add("vColor","vec4"),y.add("vpos","vec3",{invariant:!0}),y.add("vUV","vec2"),y.add("vSize","float"),P&&y.add("vLineWidth","float"),a.uniforms.add(new re("nearFar",({camera:l})=>l.nearFar),new ae("viewport",({camera:l})=>l.fullViewport)).code.add(o`vec4 projectAndScale(vec4 pos) {
